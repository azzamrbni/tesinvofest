              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">support@galeriharapan.id</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 text-sm">Sen-Jum, 09:00-17:00</p>
                  </div>
                </a>
              </div>
                ...
                >
                  ...
                  {openIndex === index && (
                    <motion.div
                      ...
                      className="px-6 pb-6"
                    >
                      <div className="pl-10 text-gray-900 leading-relaxed">
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
